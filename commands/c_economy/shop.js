  ...
  run: async (bot, message, args) => {
    ...
    if (respGlob.includes(resp)) {
      ...
      .addFields(
        ...
        value: `Увеличивает ставку для всех игр(до 1.000.000), доступ к командам - AFK, эмбед, канал, уровни(включение системы уровней) и био профиля, и так же увеличивает стоимость рыб(на 33%).`,
        inline: false},
