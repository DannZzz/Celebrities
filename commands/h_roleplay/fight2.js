...
module.exports = {
  ...
  run: async (bot, message, args) => {
    ...
    const first = await Canvas.loadImage(data1.url);
    const second = await Canvas.loadImage(data2.url);
    ...
    const att = new MessageAttachment(canvas.toBuffer(), 'fight.png')
    const eamb = new MessageEmbed()
    .setColor(cyan)
