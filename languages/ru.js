...
module.exports = {   
    ...
    "trial": {
        ...
        "trial": time => `Попробуйте снова через **${time.getMinutes()} м. ${time.getSeconds()} с.**`,
        "usage": "",
        "access": "Для всех",
    },
    ...
    "teamModel": {
        "noTeam": "Ваш клан не имеет военную тиму.",
        "kicked": "Участник успешно убран.",
        "gg": "Тима заполнена!",
        "done1": "Участник успешно добавлень в тиму.",
        "notThisLeader": "Лидер этого клана не находится на этом сервере.",
        "thisClanNotTeam": "Этот клан не имеет военную тиму.",
        "youBudget": "У вас недостаточно рубинов.",
        "targetBudget": "Этот клан не имеет столько рубинов.",
        "declined": "Лидер этого клана отказался.",
        "winner": "Победитель",
        "req": bet => `вашему клану бросили вызов на __${bet}__.`,
        "waiting": "Подождите..."
    },
    ...
    "war": {
        "desc": "Начать клановую войну.",
        "usage": "[номер клана] <ставка>",
        "access": "Для всех",
        "bet": "Укажите ставку.",
    ...
    "shop": {
        ...
        "items": () => {
            ...
            .addField(`**#11** ${item.goldBox.emoji} Временный бокс: 15₽`, `Откройте и получите один из этих призов: \`Герои: Анкалгон, Х, Беззубик, Зеро. Предметы: VIP 2, Золото 10000-50000\``)
...
🐋Легендарная :: [ID: 5]\`\`\`
    ...
    "clan": {
        ...
        "helpCommand": (star, clan) => {
            const text = `
            \`clan (число)\` — Скинуть голды в бюджет клана. ( __2 ${star}__ = __1 ${clan}__ )
            ...
            \`clan reward\` — Получить ежедневные голды.
