...
🐋Легендарная :: [ID: 5]\`\`\`
    ...
    "clan": {
        ...
        "upVip": "Вы должны иметь как минимум __VIP__ чтобы улучшить клан.",
        "upDo": "Улучшаю...",
