...
module.exports = {   
    ...
    "shop": {
        ...
        "items": () => {
            ...
            .addField(`**#11** ${item.goldBox.emoji} Временный бокс: 15₽`, `Откройте и получите один из этих призов: \`Герои: Разбитый, Х, Беззубик, Зеро. Предметы: VIP 2, Золото 10000-50000\``)
