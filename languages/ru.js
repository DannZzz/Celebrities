...
module.exports = {
    ...
    "storage": {
        "desc": "Хранилище для собранных героев.",
        "usage": "",
        "access": "Для всех",
    },
                ...
                .addFields(
                    {
                        ...
                        value: stripIndents`**[${rubToDollar(donate.classicBoost, formatNumber, "ru")} Ежемесячно](https://www.donationalerts.com/r/adanadiscord)**
                    ...
                    {
                        name: `Средний Буст 💚`,
                        value: stripIndents`**[${rubToDollar(donate.averageBoost, formatNumber, "ru")} Ежемесячно](https://www.donationalerts.com/r/adanadiscord)**
                        **Доступ к приватным героям**
                        **x2 xp Буст**
                        **+2 слот скрещиваний**
                        **+2 слот майнинга**
                    ...
                    },
                    {
                        ...
                        value: stripIndents`**[${rubToDollar(donate.maximumBoost, formatNumber, "ru")} Ежемесячно](https://www.donationalerts.com/r/adanadiscord)**
                        **Доступ к приватным героям**
                        **x3 xp Буст**
                        **+3 слот скрещиваний**
                        **+3 слот майнинга**
...
🐋Легендарная :: [ID: 5]\`\`\`
    ...
    "daily": {
        "desc": "Селендиан и лут-бокс ежедневно.",
        "usage": "",
        "access": "Для всех",
